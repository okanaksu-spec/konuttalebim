...
// PayTR canli-mod INCELEMESI icin gecici erisim bayragi. (PayTR onayi alindi)
// Artik canli-mod YALNIZCA Render'daki PAYTR_TEST_MODE=0 ile kontrol edilir;
// bu bayrak kapatildi ki tek dogruluk kaynagi ortam degiskeni olsun.
const PAYMENTS_REVIEW = false;
